...
WebUI.setText(findTestObject('Object Repository/Airbnb_1/Page_Find/input_Where_query'), 
    'Noida')
...
WebUI.verifyElementText(findTestObject('Object Repository/Airbnb_1/Page_FindResult/span_Over 1,000 places in Noida'), 
    'Over 1,000 places in Noida')
