...
* 
* Fill the username 'Object Repository/Muhub_Blue/Login/Page_LoginPage/input_User Name_Client.UserName' with the value of the local variable 'username'
* 
...
* 
* * Fill the password 'Object Repository/Muhub_Blue/Login/Page_LoginPage/input_Password_Client.Password' with the value of the local variable 'password' 
* 
* click login button with the value 'Object Repository/Muhub_Blue/Login/Page_LoginPage/input_Password_btn btn-lg btn-block btn-primary'
* 
...
// Fill the password input field with the local variable 'password'
WebUI.setText(findTestObject('Muhub_Blue/Login/Page_LoginPage/input_Password_Client.Password'), password)

// Click the login button
WebUI.click(findTestObject('Muhub_Blue/Login/Page_LoginPage/input_Password_btn btn-lg btn-block btn-primary'))

// Verify that the login result element exists with a timeout of 10 seconds
WebUI.verifyElementPresent(findTestObject('Muhub_Blue/Login/Page_LoginResult/span_SLQA - HS'), 10)
